...
- [Forge](https://forge.magery.ai/mcp) 🔓 - Security audits for shipped code. Turns scanner noise into clear risks + fixes, exposed over MCP so your agent can scan and read reports.
